/**
 * MaduraNet Hotspot Portal Logic
    ...
    if (queryUser) {
        ...
        autoLoginOverlay.innerHTML = `
            <div class="scanner-modal-content" style="text-align: center; max-width: 280px; padding: 24px 20px;">
                <h3 style="color: var(--primary-green); margin-bottom: 12px; font-size: 14px;">Mendeteksi QR Voucher</h3>
                <div class="loading-dots" style="margin: 16px 0 8px;">
                    <div class="dot"></div>
                    <div class="dot"></div>
                    <div class="dot"></div>
                </div>
                <p style="font-size: 10px; color: var(--text-muted); font-weight: 600;">Menghubungkan otomatis ke internet...</p>
            </div>
        `;
